/* The following code was generated by JFlex 1.4 on 10/25/17 10:26 PM */
...
class RubyTimeFormatLexer {
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public org.embulk.spi.time.RubyTimeFormatToken yylex() throws java.io.IOException {
    int zzInput;
    int zzAction;
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 5: 
          { return new RubyTimeFormatStringToken("%");
          }
        case 6: break;
        case 1: 
